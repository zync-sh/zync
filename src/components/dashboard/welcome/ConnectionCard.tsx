...
export function ConnectionCard({ conn, onOpen, onToggleFavorite, onContextMenu }: ConnectionCardProps) {
    ...
    function handleKeyDown(e: KeyboardEvent<HTMLDivElement>) {
        if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); onOpen(conn.id); }
    }
    ...
    return (
        <div
            ...
            className="group relative flex items-center gap-2.5 px-3 py-2.5 rounded-xl cursor-pointer transition-all hover:bg-app-surface/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent/40"
