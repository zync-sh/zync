                        ...
                        >
                            ...
                            {favorites.length > 0 && (
                                <section
                                    ...
                                    className="sm:flex-1 min-w-0 flex flex-col max-h-[40vh] overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-app-border/30 hover:[&::-webkit-scrollbar-thumb]:bg-app-border/50 [&::-webkit-scrollbar-thumb]:rounded-full"
                                >
