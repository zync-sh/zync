...
- **Pointer Event Interactivity**: Fixed a stacking context mismatch in the `FileToolbar` and `SettingsModal` menus by migrating to native click-away listeners, preventing invisible backdrops from blocking UI interactions. ([72b7046])
